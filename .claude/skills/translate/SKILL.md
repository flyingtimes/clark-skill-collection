---
name: translate
description: 提取用户给出的任何文件、文字内容翻译成目标语言,默认目标语言为中文。

---

# 输出要求
翻译后的内容写入output/translated_articles/目录，文件名为"翻译_"+原文件名

# 翻译要求
你你尽一切努力避免译文中包含未经翻译的单词、短句、内容。
...
# 翻译件保存
在项目根目录的output文件夹中保存翻译文档。文档名称为{中文文件名称}.txt